...
// footmercato.net's /rss, lequipe.fr's old rss path, gsp.ro's /feed,
// sport.ro's /feed, sky sports' generic feed) were left out rather than
// wired in and hoped to work. Re-verify before adding more: a feed that
// returns HTTP 200 with an empty or stale <item> list looks identical to a
// healthy one until you actually read the dates.
//
